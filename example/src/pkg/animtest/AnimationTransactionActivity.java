...
public class AnimationTransactionActivity extends Activity {


  private SinewaveAnimation mMoveAnimation;
  private FloatValueAnimation mRotateAnimation;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(pkg.animtest.R.layout.activity_transaction);
    ...
    mRotateAnimation = new FloatValueAnimation();
